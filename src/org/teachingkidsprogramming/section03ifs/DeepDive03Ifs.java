...
public class DeepDive03Ifs
{
  ...
  //  }
  //  @Test
  //  public void cyoaWakeUp() throws Exception
  //  {
  //    String result = MessageBox.askForTextInput("Do you want to 'wake up' or 'explore' the dream?");
  //    Assert.assertEquals(result, "explore");
  //  }
  //  @Test
  //  public void cyoaNoAnswerInput() throws Exception
  //  {
  //    String result = MessageBox.askForTextInput("Do you want to 'wake up' or 'explore' the dream?");
  //    Assert.assertEquals("", result);
  //  }
  @Test
  public void mayIGoToTheBathroom() throws Exception
  {
  ...
  @Test
  public void isDankAMeme() throws Exception
  {
    String dankIs = "not a meme";
    if (true)
    {
      dankIs = "a meme";
    }
    Assert.assertEquals("a meme", dankIs);
  }
  /**
